...
{:full-name "Alan Malloy"
 :usernames #{ "amalloy" }
 :emails #{ "alan@malloys.org" }
 :contributor true
 }
{:full-name "Ambrose Bonnaire-Sergeant"
 :usernames #{ "ambrosebs" }
...
{:full-name "Matthew Lee Hinman"
 :aliases #{ "Matthew Hinman" }
 :usernames #{ "thnetos" }
 :emails #{ "lee@writequit.org" }
 :contributor true
 }
{:full-name "Tim McCormack"
 :aliases #{ }
 :usernames #{ "timmc" }
